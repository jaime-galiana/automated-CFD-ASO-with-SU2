...
public class macro_with_prism extends StarMacro {
  ...
  private void execute0() {
    ...
    simulation_0.get(SolidModelManager.class).importFilesInto3DCad(new StringVector(new String[] {resolvePath("/rds/general/user/jg2219/ephemeral/Final-RANS/bin/domain.STEP")}), cadModel_1, true, false, false, false, false, false, false, true, false, true, NeoProperty.fromString("{\'STEP\': 0, \'NX\': 0, \'CATIAV5\': 0, \'SE\': 0, \'JT\': 0}"));
    ...
    AutoMeshOperation autoMeshOperation_0 = 
      simulation_0.get(MeshOperationManager.class).createAutoMeshOperation(new StringVector(new String[] {"star.resurfacer.ResurfacerAutoMesher", "star.delaunaymesher.DelaunayAutoMesher", "star.prismmesher.PrismAutoMesher"}), new NeoObjectVector(new Object[] {meshPart_0}));
    ...
    surfaceCurvature_0.setNumPointsAroundCircle(45.0);
    ...
    integerValue_0.getQuantity().setValue(70.0);

    autoMeshOperation_0.getDefaultValues().get(PrismWallThickness.class).setValue(0.000005);

    autoMeshOperation_0.getDefaultValues().get(PrismWallThickness.class).setUnits(units_0);
    ...
    ((ScalarPhysicalQuantity) prismThickness_0.getAbsoluteSizeValue()).setValue(0.012);

    ((ScalarPhysicalQuantity) prismThickness_0.getAbsoluteSizeValue()).setUnits(units_0);

    GenerateStandardPrismaticCells generateStandardPrismaticCells_0 = 
      autoMeshOperation_0.getDefaultValues().get(GenerateStandardPrismaticCells.class);

    generateStandardPrismaticCells_0.setGenerateStandardPrismaticCells(true);

    MaximumCellSize maximumCellSize_0 = 
      autoMeshOperation_0.getDefaultValues().get(MaximumCellSize.class);

    maximumCellSize_0.getRelativeSizeScalar().setValue(200000.0);
    ...
    partsCoreMeshOptimizer_0.setQualityThreshold(0.7);
    ...
    partsTargetSurfaceSize_1.getRelativeSizeScalar().setValue(200000.0);
    ...
    surfaceCurvature_1.setNumPointsAroundCircle(270.0);
